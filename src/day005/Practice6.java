...
public class Practice6 {
    public static void main(String[] args) {
        ...
        System.out.print("상품명: ");  String products8 =  scan.next();
        System.out.print("수량: ");   int stock8 = scan.nextInt();
        ...
        if(check==2){System.out.println("제품이 존재하지 않습니다.");}   // for 밖에서 (끝나고) 제품없음 출력한다.
        else if(check ==1){System.out.println("구매완료");}           // 출력은 그냥 반복문 끝나고 하는 게 나을 듯
        else if(check==0){System.out.println("재고 부족");}
